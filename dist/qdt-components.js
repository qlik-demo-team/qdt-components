...
*/
var aa=__webpack_require__(0),n=__webpack_require__(17),q=__webpack_require__(34);function u(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(u(227));var ba=null,ca={};
...
// Imports
var getUrl = __webpack_require__(40);
var ___CSS_LOADER_URL___0___ = getUrl(__webpack_require__(41));
var ___CSS_LOADER_URL___1___ = getUrl(__webpack_require__(42));
// Module
...
var esm_typeof = __webpack_require__(10);

// CONCATENATED MODULE: ./node_modules/@material-ui/utils/esm/deepmerge.js


function isObject(item) {
  return item && Object(esm_typeof["a" /* default */])(item) === 'object' && !Array.isArray(item);
}
...
function createBreakpoints(breakpoints) {
  ...
  function between(start, end) {
    var endIndex = createBreakpoints_keys.indexOf(end);

    if (endIndex === createBreakpoints_keys.length - 1) {
      return up(start);
    }

    return "@media (min-width:".concat(typeof values[start] === 'number' ? values[start] : start).concat(unit, ") and ") + "(max-width:".concat((endIndex !== -1 && typeof values[createBreakpoints_keys[endIndex + 1]] === 'number' ? values[createBreakpoints_keys[endIndex + 1]] : end) - step / 100).concat(unit, ")");
  }
...
function ThemeProvider(props) {
  ...
  return react_default.a.createElement(useTheme_ThemeContext.Provider, {
    value: theme
  }, children);
}
...
// CONCATENATED MODULE: ./src/themes/Colors.js
var Colors = {
  // Signature Colors
  QLIK_GREEN: '#009845',
  QLIK_GREY: '#54565A',
  ...
  SLATE: '#244B5A',
  TURQUOISE: '#006580',
  TURQUOISE_LIGHT: '#0180a3',
  TURQUOISE_DARK: '#00485b',
  AQUAMARINE: '#10CFC9',
  WINE: '#4c0038',
  WINE_LIGHT: '#c12e9a',
  WINE_DARK: '#870064',
...
/* harmony default export */ var themes_Colors = (Colors);
...
var Light_theme = {
  palette: {
    ...
    // },
    primary: {
      light: themes_Colors.TURQUOISE_LIGHT,
      main: themes_Colors.TURQUOISE,
      dark: themes_Colors.TURQUOISE_DARK,
      contrastText: '#fff'
    },
    secondary: {
      light: themes_Colors.WINE_LIGHT,
      main: themes_Colors.WINE,
      dark: themes_Colors.WINE_DARK,
      contrastText: '#fff'
    },
    success: {
      light: themes_Colors.EMERALD,
      main: themes_Colors.EMERALD,
      dark: themes_Colors.EMERALD,
      contrastText: '#fff'
    },
    error: {
      light: themes_Colors.RUBY,
      main: themes_Colors.RUBY,
      dark: themes_Colors.RUBY,
      contrastText: '#fff'
    },
    info: {
      // SAPPHIRE
      light: themes_Colors.AQUAMARINE,
      main: themes_Colors.AQUAMARINE,
      dark: themes_Colors.AQUAMARINE,
      contrastText: '#fff'
    }
  },
  shape: {
  ...
  overrides: {
    ...
    MuiMenuItem: {
      root: {
        '&$selected': {
          backgroundColor: themes_Colors.QLIK_GREEN,
          color: '#FFF',
          '&:hover': {
            backgroundColor: themes_Colors.QLIK_GREEN
          }
...
/* harmony default export */ var Light = (Light_theme);
...
// CONCATENATED MODULE: ./src/qdtNova.jsx
 //eslint-disable-line
...
/* harmony default export */ var qdtNova = (function (supernova) {
      ...
      return (
        /* env */
        {
          component: function component() {
            var app = supernova.useApp();
            var layout = supernova.useLayout();
            var model = supernova.useModel();
            var element = supernova.useElement();
            var theme = styles_createMuiTheme(Light);
            supernova.useEffect(function () {
...
var jss_plugin_default_unit_esm_percent = hasCSSTOMSupport && CSS ? CSS.percent : '%';
/**
...
var urlFix = function urlFix(url) {
  ...
  var _url = "".concat(tempUrl[0], "//").concat(tempUrl[2], "/").concat(url.substring(sbstrIndex, url.length));

  return _url;
};

var QdtButton_QdtButton = function QdtButton(_ref) {
  var app = _ref.app,
      vis = _ref.vis,
      type = _ref.type,
      label = _ref.label,
  ...
  var options = _objectSpread({}, defaultOptions, {}, optionsProp);

  var handleClick = Object(react["useCallback"])(
  /*#__PURE__*/
    ...
    return regenerator_default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.t0 = type;
            _context.next = _context.t0 === 'exportData' ? 3 : _context.t0 === 'exportImg' ? 11 : _context.t0 === 'exportPdf' ? 19 : _context.t0 === 'clearSelections' ? 27 : 27;
            break;
          ...
          case 3:
            ...
            _context.next = 7;
            return vis.exportData(_options);
          ...
          case 11:
            ...
            _context.next = 15;
            return vis.exportImg(_options2);
          ...
          case 19:
            ...
            _context.next = 23;
            return vis.exportPdf(_options3);
  ...
  return react_default.a.createElement(react_default.a.Fragment, null, react_default.a.createElement(esm_Button_Button, {
    variant: "contained",
    color: "primary",
    onClick: handleClick
  }, label));
...
QdtButton_QdtButton.propTypes = {
  app: prop_types_default.a.object,
  vis: prop_types_default.a.object,
  type: prop_types_default.a.oneOf(['clearSelections', 'exportData', 'exportImg', 'exportPdf']),
...
var QdtKpi_QdtKpi = function QdtKpi(_ref) {
  var layout = _ref.layout,
      specifier = _ref.format;
  var value = Object(react["useMemo"])(function () {
    return defaultLocale_format(specifier)(layout.qMatrix[0][0].qText);
  }, [layout, specifier]);
...
var Portal_Portal = react_default.a.forwardRef(function Portal(props, ref) {
  ...
  var handleRef = useForkRef(react_default.a.isValidElement(children) ? children.ref : null, ref);
...
var Popover_Popover = react_default.a.forwardRef(function Popover(props, ref) {
  ...
  var setPositioningStyles = react_default.a.useCallback(function () {
...
var SelectInput_SelectInput = react_default.a.forwardRef(function SelectInput(props, ref) {
  ...
  react_default.a.createElement("span", {
    ...
    className: clsx_m(classes.icon, classes["icon".concat(capitalize(variant))], open && classes.iconOpen)
...
var InputBase_InputBase = react_default.a.forwardRef(function InputBase(props, ref) {
  ...
  return react_default.a.createElement("div", _extends({
    className: clsx_m(classes.root, classes["color".concat(capitalize(fcs.color || 'primary'))], className, fcs.disabled && classes.disabled, fcs.error && classes.error, fullWidth && classes.fullWidth, fcs.focused && classes.focused, muiFormControl && classes.formControl, multiline && classes.multiline, startAdornment && classes.adornedStart, endAdornment && classes.adornedEnd, {
      dense: classes.marginDense
    }[fcs.margin]),
    onClick: handleClick,
    ref: ref
    ...
    className: clsx_m(classes.input, inputPropsProp.className, fcs.disabled && classes.disabled, multiline && classes.inputMultiline, fcs.hiddenLabel && classes.inputHiddenLabel, startAdornment && classes.inputAdornedStart, endAdornment && classes.inputAdornedEnd, {
...
var NotchedOutline_NotchedOutline = react_default.a.forwardRef(function NotchedOutline(props, ref) {
  ...
  if (label !== undefined) {
    ...
    }, label ? react_default.a.createElement("span", null, label) : react_default.a.createElement("span", {
      dangerouslySetInnerHTML: {
        __html: '&#8203;'
      }
    })));
...
var LinearProgress_LinearProgress = react_default.a.forwardRef(function LinearProgress(props, ref) {
  var classes = props.classes,
      className = props.className,
      _props$color = props.color,
      color = _props$color === void 0 ? 'primary' : _props$color,
  ...
  return react_default.a.createElement("div", _extends({
    ...
    ref: ref
  }, other), variant === 'buffer' ? react_default.a.createElement("div", {
    className: clsx_m(classes.dashed, classes["dashedColor".concat(capitalize(color))])
  }) : null, react_default.a.createElement("div", {
    className: clsx_m(classes.bar, classes["barColor".concat(capitalize(color))], (variant === 'indeterminate' || variant === 'query') && classes.bar1Indeterminate, {
      determinate: classes.bar1Determinate,
      buffer: classes.bar1Buffer
    }[variant]),
    style: inlineStyles.bar1
  }), variant === 'determinate' ? null : react_default.a.createElement("div", {
    className: clsx_m(classes.bar, (variant === 'indeterminate' || variant === 'query') && classes.bar2Indeterminate, variant === 'buffer' ? [classes["color".concat(capitalize(color))], classes.bar2Buffer] : classes["barColor".concat(capitalize(color))]),
    style: inlineStyles.bar2
  }));
});
 false ? undefined : void 0;
/* harmony default export */ var esm_LinearProgress_LinearProgress = (styles_withStyles(LinearProgress_styles, {
...
// CONCATENATED MODULE: ./src/components/QdtSelect/QdtSelect.jsx
/**
 * @name QdtSelect
 * @param {object} layout - Qlik object layout
...
var QdtSelect_QdtSelect = function QdtSelect(_ref) {
  var layout = _ref.layout,
      model = _ref.model,
      optionsProp = _ref.options;
  var defaultOptions = {
  ...
  var options = cjs_default()(defaultOptions, optionsProp);

  var _useRef = Object(react["useRef"])(v4_default()()),
      id = _useRef.current;

  var selectValue = Object(react["useMemo"])(function () {
    var sv = layout.qListObject.qDataPages[0].qMatrix.filter(function (row) {
      return row[0].qState === 'S';
    });
    return options.multiple ? sv : sv[0];
  }, [layout.qListObject.qDataPages, options.multiple]);
  var selectRenderValue = Object(react["useMemo"])(function (selected) {
    if (!selected) return;
    ...
    return "".concat(selected.length, " of ").concat(layout.qListObject.qSize.qcy, " selected");
  }, [layout]);
  var handleOpen = Object(react["useCallback"])(function () {
  ...
  var handleChange = Object(react["useCallback"])(function (event) {
    var qValues = event.target.value.map(function (v) {
      return options.multiple ? v[0].qElemNumber : v.qElemNumber;
    });
    model.selectListObjectValues('/qListObjectDef', qValues, false);
  }, [model, options.multiple]);
  var handleSearch = Object(react["useCallback"])(function (event) {
    model.searchListObjectFor('/qListObjectDef', event.target.value);
  }, [model]);
  return react_default.a.createElement(react_default.a.Fragment, null, react_default.a.createElement(esm_FormControl_FormControl, {
    variant: "outlined"
  }, react_default.a.createElement(esm_InputLabel_InputLabel, {
    id: "".concat(id, "-label")
  }, layout.qListObject.qDimensionInfo.qFallbackTitle), react_default.a.createElement(esm_Select_Select, {
    ...
    onClose: handleClose,
    onChange: handleChange,
    input: react_default.a.createElement(esm_Input_Input, null)
  }, react_default.a.createElement(esm_MenuItem_MenuItem, null, react_default.a.createElement(esm_Input_Input, {
    type: "search",
    onChange: handleSearch
  })), layout.qListObject.qDataPages[0].qMatrix.map(function (row) {
    return react_default.a.createElement(esm_MenuItem_MenuItem, {
      key: row[0].qElemNumber,
      value: row,
      className: classnames_default()('item', {
        'styles.selected': row[0].qState === 'S',
        'styles.excluded': row[0].qState === 'X'
      })
    }, row[0].qText);
  })), react_default.a.createElement(esm_LinearProgress_LinearProgress, {
    variant: "determinate",
    value: 80
  })));
};

QdtSelect_QdtSelect.propTypes = {
  layout: prop_types_default.a.object,
  model: prop_types_default.a.object,
  options: prop_types_default.a.object
};
QdtSelect_QdtSelect.defaultProps = {
  layout: null,
  model: null,
  options: {}
};
/* harmony default export */ var components_QdtSelect_QdtSelect = (QdtSelect_QdtSelect);
...
function utils_objectWithoutProperties(obj, keys) { var target = {}; for (var i in obj) { if (keys.indexOf(i) >= 0) continue; if (!Object.prototype.hasOwnProperty.call(obj, i)) continue; target[i] = obj[i]; } return target; }
...
function makeTemplateComponent(compClass, displayName) {
  ...
  var cmp = function cmp(_ref) {
    var children = _ref.children,
        ...
        rest = utils_objectWithoutProperties(_ref, ['children', 'className']);
...
function splitProps(_ref2) {
  var className = _ref2.className,
      style = _ref2.style,
      rest = utils_objectWithoutProperties(_ref2, ['className', 'style']);
...
//# sourceMappingURL=data:application/json;base64,
...
//# sourceMappingURL=data:application/json;base64,
// CONCATENATED MODULE: ./node_modules/react-table/es/methods.js
var methods_slicedToArray = function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"]) _i["return"](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError("Invalid attempt to destructure non-iterable instance"); } }; }();
...
function methods_toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }
  ...
  return function (_Base) {
    ...
    methods_createClass(_class, [{
      ...
      value: function getDataModel(newState, dataChanged) {
        ...
        var columnsWithExpander = [].concat(methods_toConsumableArray(columns));
        ...
        if (SubComponent && !expanderColumn) {
          ...
          columnsWithExpander = [expanderColumn].concat(methods_toConsumableArray(columnsWithExpander));
        }
        ...
        var accessRow = function accessRow(d, i) {
          ...
          var row = (_row = {}, methods_defineProperty(_row, originalKey, d), methods_defineProperty(_row, indexKey, i), methods_defineProperty(_row, subRowsKey, d[subRowsKey]), methods_defineProperty(_row, nestingLevelKey, level), _row);
        ...
        if (pivotBy.length) {
          var groupRecursively = function groupRecursively(rows, keys) {
            ...
            var groupedRows = Object.entries(utils.groupBy(rows, keys[i])).map(function (_ref) {
              ...
              return _ref3 = {}, methods_defineProperty(_ref3, pivotIDKey, keys[i]), methods_defineProperty(_ref3, pivotValKey, key), methods_defineProperty(_ref3, keys[i], key), methods_defineProperty(_ref3, subRowsKey, value), methods_defineProperty(_ref3, nestingLevelKey, i), methods_defineProperty(_ref3, groupedByPivotKey, true), _ref3;
            });
            ...
            groupedRows = groupedRows.map(function (rowGroup) {
              ...
              return methods_extends({}, rowGroup, (_extends2 = {}, methods_defineProperty(_extends2, subRowsKey, subRows), methods_defineProperty(_extends2, aggregatedKey, true), _extends2), aggregate(subRows));
            });
            return groupedRows;
          };
      ...
      value: function filterData(data, filtered, defaultFilterMethod, allVisibleColumns) {
        ...
        if (filtered.length) {
          ...
          filteredData = filteredData.map(function (row) {
            ...
            return methods_extends({}, row, methods_defineProperty({}, _this3.props.subRowsKey, _this3.filterData(row[_this3.props.subRowsKey], filtered, defaultFilterMethod, allVisibleColumns)));
          }).filter(function (row) {
            if (!row[_this3.props.subRowsKey]) {
              return true;
            }
...
/* harmony default export */ var es_defaultProps = ({
  // General
  data: [],
...
var ReactTableDefaults = es_defaultProps;
    ...
    value: function render() {
      ...
      var makeFilter = function makeFilter(column, i) {
        ...
        return react_default.a.createElement(
          ...
          }, es_defaultProps.column.Filter) : null
        );
      };
...
es_ReactTable.defaultProps = es_defaultProps;
...
var react_table = __webpack_require__(52);
...
var QdtTable_QdtTable = function QdtTable(_ref) {
  ...
  var columns = Object(react["useMemo"])(function () {
    return layout ? [].concat(toConsumableArray_default()(layout.qHyperCube.qDimensionInfo.map(function (col, index) {
      return {
        Header: col.qFallbackTitle,
        accessor: function accessor(d) {
          return d[index].qText;
        },
        defaultSortDesc: col.qSortIndicator === 'D',
        id: col.qFallbackTitle,
        qInterColumnIndex: index,
        qPath: "/qHyperCubeDef/qDimensions/".concat(index),
        qSortIndicator: col.qSortIndicator,
        qReverseSort: col.qReverseSort
      };
    })), toConsumableArray_default()(layout.qHyperCube.qMeasureInfo.map(function (col, index) {
      return {
        Header: col.qFallbackTitle,
        accessor: function accessor(d) {
          return d[index + layout.qHyperCube.qDimensionInfo.length].qText;
        },
        defaultSortDesc: col.qSortIndicator === 'D',
        id: col.qFallbackTitle,
        qInterColumnIndex: index + layout.qHyperCube.qDimensionInfo.length,
        qPath: "/qHyperCubeDef/qMeasures/".concat(index),
        qSortIndicator: col.qSortIndicator,
        qReverseSort: col.qReverseSort
      };
    }))) : [];
  ...
  var pages = Object(react["useMemo"])(function () {
    return layout && Math.ceil(layout.qHyperCube.qSize.qcy / options.pageSize);
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              return model.getHyperCubeData('/qHyperCubeDef', [{
                ...
                qHeight: options.pageSize,
                qTop: options.pageSize * page
              }]);

            case 3:
              dataPages = _context.sent;
              setData(dataPages[0]);
              setLoading(false);
  ...
  function () {
    ...
    /*#__PURE__*/
    regenerator_default.a.mark(function _callee2(newSorted, column) {
          ...
          switch (_context2.prev = _context2.next) {
            ...
            case 7:
              ...
              return model.applyPatches([{
                ...
                qValue: JSON.stringify(toConsumableArray_default()(layout.qHyperCube.qEffectiveInterColumnSortOrder).sort(function (a, b) {
      ...
      return {
        onClick: function onClick(e, handleOriginal) {
          if (column && rowInfo && column.qPath.includes('qDimensions') && rowInfo.original[column.qInterColumnIndex].qstate !== 'L') {
            model.selectHyperCubeValues('/qHyperCubeDef', column.qInterColumnIndex, [rowInfo.original[column.qInterColumnIndex].qElemNumber], true);
          }
...
var ButtonGroup_ButtonGroup = react_default.a.forwardRef(function ButtonGroup(props, ref) {
  ...
  var buttonClassName = clsx_m(classes.grouped, classes["grouped".concat(capitalize(orientation))], classes["grouped".concat(capitalize(variant))], classes["grouped".concat(capitalize(variant)).concat(capitalize(orientation))], classes["grouped".concat(capitalize(variant)).concat(color !== 'default' ? capitalize(color) : '')], disabled && classes.disabled);
  return react_default.a.createElement(Component, _extends({
    role: "group",
    className: clsx_m(classes.root, className, fullWidth && classes.fullWidth, {
    ...
    return react_default.a.cloneElement(child, {
      className: clsx_m(buttonClassName, child.props.className),
 ...
 false ? undefined : void 0;
/* harmony default export */ var esm_ButtonGroup_ButtonGroup = (styles_withStyles(ButtonGroup_styles, {
  name: 'MuiButtonGroup'
})(ButtonGroup_ButtonGroup));
// CONCATENATED MODULE: ./node_modules/@material-ui/icons/esm/utils/createSvgIcon.js



function createSvgIcon_createSvgIcon(path, displayName) {
  var Component = react_default.a.memo(react_default.a.forwardRef(function (props, ref) {
    return react_default.a.createElement(esm_SvgIcon_SvgIcon, _extends({
      ref: ref
    }, props), path);
  }));
...
// CONCATENATED MODULE: ./node_modules/@material-ui/icons/esm/SkipPrevious.js


/* harmony default export */ var SkipPrevious = (createSvgIcon_createSvgIcon(react_default.a.createElement("path", {
  d: "M6 6h2v12H6zm3.5 6l8.5 6V6z"
}), 'SkipPrevious'));
// CONCATENATED MODULE: ./node_modules/@material-ui/icons/esm/PlayArrow.js


/* harmony default export */ var PlayArrow = (createSvgIcon_createSvgIcon(react_default.a.createElement("path", {
  d: "M8 5v14l11-7z"
}), 'PlayArrow'));
// CONCATENATED MODULE: ./node_modules/@material-ui/icons/esm/Pause.js


/* harmony default export */ var Pause = (createSvgIcon_createSvgIcon(react_default.a.createElement("path", {
  d: "M6 19h4V5H6v14zm8-14v14h4V5h-4z"
}), 'Pause'));
// CONCATENATED MODULE: ./node_modules/@material-ui/icons/esm/Stop.js


/* harmony default export */ var Stop = (createSvgIcon_createSvgIcon(react_default.a.createElement("path", {
  d: "M6 6h12v12H6z"
}), 'Stop'));
// CONCATENATED MODULE: ./node_modules/@material-ui/icons/esm/SkipNext.js


/* harmony default export */ var SkipNext = (createSvgIcon_createSvgIcon(react_default.a.createElement("path", {
...
var QdtSequencer_QdtSequencer = function QdtSequencer(_ref) {
  ...
  var options = cjs_default()(defaultOptions, optionsProp); // const [init, setInit] = useState(false);
  ...
  var _useState3 = Object(react["useState"])(0),
      _useState4 = slicedToArray_default()(_useState3, 2),
      currentRowIndex = _useState4[0],
      setCurrentRowIndex = _useState4[1];

  var handleStartSequencer = function handleStartSequencer() {
    return setPlay(true);
  };

  var handleStopSequencer = function handleStopSequencer() {
    return setPlay(false);
  };

  var select = Object(react["useCallback"])(function (qElemNumber) {
    var toggle = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
    var ignoreLock = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    return model.selectListObjectValues('/qListObjectDef', [qElemNumber], toggle, ignoreLock);
  }, [model]);
  var clearSelections = Object(react["useCallback"])(function () {
    return model.clearSelections('/qListObjectDef');
  }, [model]);

  var handleMoveNextSequencer = function handleMoveNextSequencer() {
  ...
  var handleMovePreviousSequencer = function handleMovePreviousSequencer() {
  ...
  var handleReloadSequencer = function handleReloadSequencer() {
    setCurrentRowIndex(0);
    if (options.selectRow) clearSelections();
  };

  Object(react["useEffect"])(function () {
    if (play) setTimeout(function () {
    ...
    if (play && currentRowIndex === layout.qListObject.qDataPages[0].qMatrix.length - 1) setPlay(false); // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [play, currentRowIndex]);
  return react_default.a.createElement(esm_ButtonGroup_ButtonGroup, {
    size: options.size,
    variant: options.variant,
    color: options.color,
    "aria-label": "qdt-sequencer"
  }, react_default.a.createElement(esm_Button_Button, {
    onClick: handleMovePreviousSequencer,
    disabled: currentRowIndex === 0
  }, react_default.a.createElement(SkipPrevious, null)), react_default.a.createElement(esm_Button_Button, {
    onClick: handleStartSequencer,
    disabled: play
  }, react_default.a.createElement(PlayArrow, null)), react_default.a.createElement(esm_Button_Button, {
    onClick: handleStopSequencer,
    disabled: !play
  }, react_default.a.createElement(Pause, null)), react_default.a.createElement(esm_Button_Button, {
    onClick: handleReloadSequencer,
    disabled: play || currentRowIndex === 0
  }, react_default.a.createElement(Stop, null)), react_default.a.createElement(esm_Button_Button, {
    onClick: handleMoveNextSequencer,
    disabled: currentRowIndex < layout.qListObject.qDataPages[0].qMatrix.length
  }, react_default.a.createElement(SkipNext, null)));
};
...
function ValueLabel(props) {
  ...
  return react_default.a.cloneElement(children, {
    className: clsx_m(children.props.className, (open || valueLabelDisplay === 'on') && classes.open, classes.thumb)
  }, react_default.a.createElement("span", {
    className: clsx_m(classes.offset, className)
  }, react_default.a.createElement("span", {
...
/* harmony default export */ var Slider_ValueLabel = (styles_withStyles(ValueLabel_styles, {
...
var Slider_Slider = react_default.a.forwardRef(function Slider(props, ref) {
  ...
  return react_default.a.createElement(Component, _extends({
    ref: handleRef,
    className: clsx_m(classes.root, classes["color".concat(capitalize(color))], className, disabled && classes.disabled, marks.length > 0 && marks.some(function (mark) {
      return mark.label;
    ...
    return react_default.a.createElement(react_default.a.Fragment, {
      ...
      style: style,
      className: clsx_m(classes.mark, markActive && classes.markActive)
    }), react_default.a.createElement("span", {
      "aria-hidden": true,
      style: style,
      className: clsx_m(classes.markLabel, markActive && classes.markLabelActive)
    }, mark.label));
    ...
    return react_default.a.createElement(ValueLabelComponent, {
      ...
      className: clsx_m(classes.thumb, classes["thumbColor".concat(capitalize(color))], active === index && classes.active, disabled && classes.disabled, focusVisible === index && classes.focusVisible),
      tabIndex: disabled ? null : 0,
      role: "slider",
      style: style,
      "data-index": index,
 ...
 false ? undefined : void 0;
/* harmony default export */ var esm_Slider_Slider = (styles_withStyles(Slider_styles, {
  name: 'MuiSlider'
})(Slider_Slider));
// CONCATENATED MODULE: ./src/components/QdtSlider/QdtSlider.jsx
...
var QdtSlider_QdtSlider = function QdtSlider(_ref) {
  var layout = _ref.layout,
      model = _ref.model,
      optionsProp = _ref.options;
  var defaultOptions = {
  ...
  var ThumbComponent = function ThumbComponent(props) {
    var aria = props['aria-valuenow'];
    return react_default.a.createElement("div", props, layout.qListObject.qDataPages[0].qMatrix[aria][0].qText);
  };

  ThumbComponent.propTypes = {
    'aria-valuenow': prop_types_default.a.number.isRequired
  };
  ...
  var handleChangeCommitted = function handleChangeCommitted(event, index) {
    return model.selectListObjectValues('/qListObjectDef', [layout.qListObject.qDataPages[0].qMatrix[index][0].qElemNumber], false);
  };

  var max = Object(react["useMemo"])(function () {
    return layout.qListObject.qDataPages[0].qMatrix.length;
  }, [layout.qListObject.qDataPages]);
  Object(react["useEffect"])(function () {
    var selected = 0;
    layout.qListObject.qDataPages[0].qMatrix.forEach(function (val, index) {
  ...
  }, react_default.a.createElement(esm_Slider_Slider, {
...
QdtSlider_QdtSlider.propTypes = {
  layout: prop_types_default.a.object,
  model: prop_types_default.a.object,
  options: prop_types_default.a.object
};
QdtSlider_QdtSlider.defaultProps = {
  layout: null,
  model: null,
  options: {}
};
/* harmony default export */ var components_QdtSlider_QdtSlider = (QdtSlider_QdtSlider);
// CONCATENATED MODULE: ./src/index.jsx
/* concated harmony reexport qdtNova */__webpack_require__.d(__webpack_exports__, "qdtNova", function() { return qdtNova; });
/* concated harmony reexport QdtButton */__webpack_require__.d(__webpack_exports__, "QdtButton", function() { return components_QdtButton_QdtButton; });
/* concated harmony reexport QdtKpi */__webpack_require__.d(__webpack_exports__, "QdtKpi", function() { return components_QdtKpi_QdtKpi; });

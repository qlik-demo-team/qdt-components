...
declare module "components/QdtPicasso/settings/scatterPlot" {
    ...
    function ScatterPlot({ theme: themeProp, properties: propertiesProp, point: pointProp, pointImage: pointImageProp, labels: labelsProp, legend: legendProp, tooltip: tooltipProp, range: rangeProp, }?: {
        theme?: {} | undefined;
        properties?: {} | undefined;
        point?: {} | undefined;
        pointImage?: any;
